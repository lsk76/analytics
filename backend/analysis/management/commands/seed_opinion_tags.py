...
CATEGORIES = [
    ...
    {
        # Спільна гео-категорія (events + monitor): місто/селище як тег замість
        # окремого поля Event.settlement. Відкрита — нові населені пункти
        # створюються; канонізація грам. варіантів через TagAlias.
        "key": "settlement",
        "label": "Населений пункт",
        "closed": False,
        "hint": "Місто/селище, якого стосується запис (напр. Махачкала, Казань).",
        "order": 55,
    },
]
