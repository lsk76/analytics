    ...
    def handle(self, *args, **opts):
        ...
        server = MCPServer(
            ...
            instructions=(
                ...
                "Починай зі `service_health`. Видимість даних — як в адмінці: свої "
                "задачі та свої або спільні акаунти. Зміни доступні за роллю "
                "(оператор/адмін), кожен виклик потрапляє в журнал."),
