...
**Промпти живуть у ПОЛЯХ ЗАДАЧІ** (prescreen_prompt/tagger_prompt, адмінка) — з 2026-07-06
канон: англійська інструкція + українські ключі тегів дослівно, БЕЗ осі opinion
(«тип думки» видалено з категорій задач 3/8), визначення на кожен тег + правило
старшинства (безіменні «власти» в чаті республіки = крит_рег_правит; крит_кремль
лише з явним федеральним маркером). A/B на 300 коментарях: рівень метрики
збережено (47.3% vs 45.7% старим), «кремль» приборкано. prompts.py — лише
запасний варіант. Деталі: **docs/comments-analysis-pipeline.md**.
