...
> **Статус: Phase 0 + Phase 1 (RSS) РЕАЛІЗОВАНО** (не закомічено). Дата: 2026-07-09.
> Працює наскрізь: RSS-джерело → Post → LLM-скрін → жива Event (перевірено E2E
> на `gazeta-n1.ru`: 8 елементів → 5 подій, approved, гео-регіон). 51 тест зелений.
> Далі: Phase 2 (web-скрапінг), Phase 3 (Telegram). Первісний дизайн нижче.
